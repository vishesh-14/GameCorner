  ...
  <div class="main">
    ...
    <div class="card">
      ...
      <div class="des">
       ...
       <a href="Ser?param=1"> <button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    </div>
    <!--cards -->
    ...
    <div class="card">
      ...
      <a href="Ser?param=2"><button><span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
       </a>
      </div>
    </div>
    <!--cards -->
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
        <a href="Ser?param=3"><button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
       </a>
      </div>
    </div>
    <!--cards -->
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
       <a href="Ser?param=4"> <button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    </div>
    <!--cards -->
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
        <a href="Ser?param=5"><button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    </div>
    <!--cards -->
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
        <a href="Ser?param=6"><button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    </div>
    <!--cards -->
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
        <a href="Ser?param=7"><button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
       </a>
      </div>
    </div>
    <!--cards -->
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
       <a href="Ser?param=8"> <button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    </div>
    <!--cards -->
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
        <a href="Ser?param=9"><button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
        <a href="Ser?param=10"><button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
        <a href="Ser?param=11"><button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    ...
    <div class="card">
      ...
      <div class="des">
        <p><h2 class="h1 font-weight-bold">$199<span class="text-small font-weight-normal ml-2">/ hour</span></h2></p>
        <a href="Ser?param=12"><button <span style="font-weight: 500; font-size: 16px; color: rgb(255, 255, 255);">Book Now</span></button>
      </a>
      </div>
    </div>
